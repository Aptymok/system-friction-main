...
<div class="lab-container">
  ...
  <div class="nav-footer">
    ...
    <a href="{{ site.baseurl }}/MIHM/caso-de-estudio/" style="padding: 0.6rem 1.2rem; border: 1px solid var(--ac); border-radius: var(--r); text-decoration: none;">Caso AGS completo</a>
